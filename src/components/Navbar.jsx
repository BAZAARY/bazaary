	...
	return (
		<>
			<div className="navbar">
				...
				<div className="font-text text-3xl pl-5 hidden md:block ">Bazaary</div>
				...
				<div className="profile-picture" onClick={() => navigate("/login")}>
					<img src={ProfileImage} alt="Foto de Perfil" />
				</div>
			</div>
			<main className="App-content">
				{/**Se usa para renderizar los hijos: HomePage, etc*/}
				<Outlet />
			</main>
		</>
	);
