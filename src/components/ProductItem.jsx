            ...
            <div id={`Producto ${index}`} className="rounded-lg shadow-xl w-full h-52 mb-5 bg-[#d9d9d9] md:h-60 md:rounded-sm">
                {urlimagen && nombreitem && precioitem ? (               
                    <div className="grid grid-rows-4 grid-cols-3 grid-flow-row h-full"> 
                        <img alt={`Imagen producto ${index}`} src={urlimagen.url} className=" row-start-1 row-end-4 self-center row-span-3 ml-4 rounded-2xl h-4/5 w-11/12 "/>
                        ...
                        <h2 className=" self-center text-right mr-9 row-start-2 ml-4 font-text text-lg">{precioitem.precio}</h2>
