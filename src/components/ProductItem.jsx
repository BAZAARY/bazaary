        ...
        <>
            <div id={`Producto ${index}`} className="rounded-lg shadow-xl w-full h-52 mb-5 bg-[#d9d9d9] md:h-60 md:rounded-sm">
                <div className="grid grid-rows-4 grid-cols-3 grid-flow-row h-full"> 
                    ...
                    <h2 className=" self-center row-start-2 ml-11 font-text text-lg"> <span className="text-green-500">Disponible: </span> 10 </h2>
                    <h2 className=" self-center text-right mr-9 row-start-2 ml-4 font-text text-xl"> $70000</h2>
